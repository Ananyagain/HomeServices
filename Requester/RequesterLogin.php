...
<body>
  <div class="mb-3 text-center mt-5" style="font-size: 30px;">
    ...
    <span>Home Services For The Elderly</span>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span>Login to Request a Service</span>
  </p>
